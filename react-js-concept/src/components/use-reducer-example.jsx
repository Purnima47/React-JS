...
const UseReducer = () => {
    ...
    return (
        <div>
            {state?.showTextFlag ? <h3 style={{ backgroundColor: state?.changeTextStyleFlag ? 'black' : 'white', color: state?.changeTextStyleFlag ? 'white' : 'black' }}>Use Reducer Hook Example</h3> : null}
